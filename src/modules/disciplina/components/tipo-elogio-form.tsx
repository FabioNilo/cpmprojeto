...
export function TipoElogioForm({
  action,
  id,
  codigo,
  nome,
  ...
  const campos = (
    <form action={formAction} className="grid gap-3 md:grid-cols-2">
      ...
      <TextField
        ...
        label="Nome"
        name="nome"
        placeholder="Ex.: Elogio Individual"
        required
      />
      <TextField
        defaultValue={valorPontos ?? "0"}
      ...
      <div className="space-y-2 md:col-span-2">
        <SubmitButton pendingLabel="Salvando...">
          {id ? "Salvar" : "Adicionar tipo de elogio"}
        </SubmitButton>
